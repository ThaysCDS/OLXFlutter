...
class _AnunciosState extends State<Anuncios> {
  ...
  List<DropdownButton<String>> _listaItensDropCategorias;
  List<DropdownButton<String>> _listaItensDropEstados;

  final _controller = StreamBuilder<QuerySnapshot>.broadcats();
